...
function MainContent() {
  return (
    <main className='mainContent'>
        <img src="/yc500.gif" alt="y" />
      <h2 className='title'>Welcome to Hacker News</h2>
      <p className='paragraph'>
        <Link className="link-of">Hacker News</Link> is a bit different from other community sites, and we'd appreciate it if you'd take a minute to read the following as well as the official guidelines.
      </p>
      <p className='paragraph'>
